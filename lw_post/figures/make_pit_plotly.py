...
Usage:
    python lw_post/figures/make_pit_plotly.py [--trace FILE] [--tag ""]
                                              [--max-draws 2000]
"""
...
from ppc import boundary_mask, pit_values, posterior_predictive_mirt  # noqa: E402
from viz.core import AI_COLOR, save_print  # noqa: E402
