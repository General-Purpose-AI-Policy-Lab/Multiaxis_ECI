...
Reads the reviewed alias map (1_curated/lineage_map.csv) and turns it into
...
from multiaxis_eci.config import CURATED_DIR

LINEAGE_MAP = CURATED_DIR / "lineage_map.csv"
