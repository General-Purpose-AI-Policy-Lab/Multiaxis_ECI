...
def signed_display_frames(view, idata):
    ...
    from multiaxis_eci.analysis import align_rotations, mirt_factors_from_trace, trace_loading_prior
...
def build_comparison(results: list):
    ...
    if len(nobs) > 1:
        ...
        loo_note = ("ΔELPD omitted for fits on modified data (different obs, "
                    "not comparable): " + ", ".join(r["name"] for r in dropped)
