...
# Category names are benchmark-data-pipeline's (September 2026); "High End Math
# Reasoning" is the pre-pipeline spelling of Mathematics, kept so old traces parse.
QMATRIX3_CAT_TO_AXIS = {
    "Mathematics": 0, "High End Math Reasoning": 0, "General Reasoning": 0,
    "Core AGI Progress": 0,
    "Autonomous SWE": 1, "Agentic Computer Use": 1, "Cyber": 1,
    "Domain Specific Questions": 2, "Trivia & Commonsense QA": 2, "Biology": 2,
    "Chemistry": 2, "Multimodal Understanding": 2, "Advanced Language and Writing": 2,
}
...
QMATRIX3X_CAT_TO_AXIS = {
    **QMATRIX3_CAT_TO_AXIS,
    "Autonomous SWE": [1, 0], "Agentic Computer Use": [1, 0], "Cyber": [1, 0],
...
QMATRIX4_CAT_TO_AXIS = {
    ...
    "Core AGI Progress": 0,
    "Autonomous SWE": 1, "Agentic Computer Use": 1, "Cyber": 1,
    "Domain Specific Questions": 2, "Trivia & Commonsense QA": 2,
    "Advanced Language and Writing": 2, "Biology": 2, "Chemistry": 2,
