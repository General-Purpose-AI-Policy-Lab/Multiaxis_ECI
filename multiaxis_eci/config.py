...
# ── Paths ─────────────────────────────────────────────────────────────────
PROJECT_ROOT = Path(__file__).resolve().parents[1]   # multiaxis_eci/config.py -> repo root
...
# IDs match `model_version` in 1_data/processed/benchmarks_merged.csv.
...
# NOT hand-maintained. `1_data/2_compute_sota.py` writes
# 1_data/curated/sota_models.txt = (frontier envelope on overall 1D capability C,
