"""Recompute the data-driven SOTA list and write data/curated/sota_models.txt.
...
Refresh: re-run after a data/fit refresh. Reviewed like the other curated maps.
  ...
  ~/miniforge3/envs/pymc_env/bin/python diagnostics/compute_sota.py
"""
...
from analysis import _release_dates, capability_draws  # noqa: E402
from config import SAMPLE_KW  # noqa: E402
from data import _effort_base, load_eci_data  # noqa: E402
from models.mirt import build_mirt_model  # noqa: E402
...
def main():
    ...
    model_dates, _ = _release_dates(pd.read_csv(ROOT / "data/processed/benchmarks_merged.csv"))
    ...
    lm_full = pd.read_csv(ROOT / "data/curated/lineage_map.csv")
