...
`data/curated/benchmark_lower_bounds.csv` is the hand-maintained ground truth
...
`data/curated/benchmark_score_clips.csv` — the reviewed row-level list of
...
import config
from data import BENCHMARK_CLIPS_FILE, BENCHMARK_FLOORS_FILE, load_eci_data
