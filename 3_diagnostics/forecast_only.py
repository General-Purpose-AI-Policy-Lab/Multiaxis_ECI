...
index.html from the caches.
    ...
    python 3_diagnostics/forecast_only.py                    # flagship
    python 3_diagnostics/forecast_only.py --fit <name> --no-html
...
from multiaxis_eci.config import PROJECT_ROOT  # noqa: E402
from multiaxis_eci.scripts import load as _load_script  # noqa: E402
_bd = _load_script("3_diagnostics/4_build_dashboard.py")
