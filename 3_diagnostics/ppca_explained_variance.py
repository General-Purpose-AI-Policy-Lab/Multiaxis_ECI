...
than a single point estimate. Output: a PDF scree report and a CSV.
    ...
    python 3_diagnostics/ppca_explained_variance.py            # all data, k>=8, no humans
    python 3_diagnostics/ppca_explained_variance.py --k 6 --draws 2000
    python 3_diagnostics/ppca_explained_variance.py --post2023
"""
