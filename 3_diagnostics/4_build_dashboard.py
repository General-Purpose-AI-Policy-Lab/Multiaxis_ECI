...
modes_path = _load_script("3_diagnostics/diagnose_chains.py").modes_path
from multiaxis_eci.data import load_benchmark_floors  # noqa: E402
...
# the trace, by `3_diagnostics/diagnose_chains.py --write-modes`, which writes
...
def _add_fit(args):
    ...
    """
    _spec_of = _load_script("3_diagnostics/3_plot_mirt.py")._spec_of
