...
Three buckets only: US, CN, Other. Method chain, in priority order:
  1. `1_data/curated/model_country_overrides.csv` (hand-reviewed) always wins.
...
Output: 1_data/curated/model_country.csv (model_version,country,organization,
...
DATA_PATH = ROOT / "1_data/processed/benchmarks_merged.csv"
OVERRIDES_PATH = ROOT / "1_data/curated/model_country_overrides.csv"
OUT_PATH = ROOT / "1_data/curated/model_country.csv"
