...
files; `4_diagnostics/3_plot_mirt.py` reads them back.
...
Run:
  python 4_diagnostics/align_mirt.py \
      --trace 5_outputs/<data>/mirt_signed_humanmerge_lineageprior/trace_mirt_k3_signed_humanmerge_lineageprior.nc
"""
