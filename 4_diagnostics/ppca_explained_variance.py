...
spectrum that archive/notebooks/multidim_ppca_ard.ipynb prints. This script fits the
...
than a single point estimate. Output: a PDF scree report and a CSV.
    ...
    python 4_diagnostics/ppca_explained_variance.py            # all data, k>=8, no humans
    python 4_diagnostics/ppca_explained_variance.py --k 6 --draws 2000
    python 4_diagnostics/ppca_explained_variance.py --post2023
"""
