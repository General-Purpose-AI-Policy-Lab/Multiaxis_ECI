...
from multiaxis_eci.analysis.timelines import (  # noqa: E402
    mirt_informed_mask,
...
_dc = _load_script("4_diagnostics/diagnose_chains.py")
...
def lump_dist_fig(theta, entries, essmap, names, majority, minority,
    ...
    for i, (m, k, note) in enumerate(entries):
        ...
        for (_rows, color, grp, lab, alpha), y in zip(groups, dens):
            fig.add_trace(go.Scatter(
