...
The feeds, their licences and the per-source processing are documented in [`benchmark-data-pipeline`](https://github.com/General-Purpose-AI-Policy-Lab/benchmark-data-pipeline), which produces `0_input/`.
