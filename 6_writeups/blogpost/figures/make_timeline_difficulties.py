...
Usage:
    python 6_writeups/blogpost/figures/make_timeline_difficulties.py [--results DIR] [--tag _draft]
"""
...
if __name__ == "__main__":
    ...
    p.add_argument("--results", type=Path, default=config.RESULTS_DIR / "canonical")
