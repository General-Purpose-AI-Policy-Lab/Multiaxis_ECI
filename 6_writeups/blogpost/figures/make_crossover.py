...
The envelope draws come from `make_trend.forecast` — the forecast
...
Usage:
    python 6_writeups/blogpost/figures/make_crossover.py [--trace FILE] [--tag ""]
"""
...
def crossovers(trace: Path, cached: bool = False,
    ...
    from make_trend import forecast
...
def main(trace: Path = TRACE, tag: str = "", out_dir: Path = HERE,
    ...
    out = out_dir / f"forecast_crossover{tag}"
