...
Run: python 6_writeups/blogpost/ladder/ladder.py
"""
...
FLAG = ROOT / ("archive/results_old/mirt_humanmerge_lineageprior_lineagebm_"
...
FITS = {
    ...
    "1": ("K=4, no ability priors",
          ROOT / "archive/results_old/mirt_dropFrontierMathv1AlgoTune_floors_poolednoise"
               / "trace_mirt_k4_dropFrontierMathv1AlgoTune_floors_poolednoise.nc"),
    "2": ("K=4 + human order",
          ROOT / "archive/results_old/mirt_humanmerge_dropFrontierMathv1AlgoTune_floors_poolednoise"
