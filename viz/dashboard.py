...
from viz.core import capability_timeline_fig, forest_fig
...
from viz.mirt import binary_qmatrix_fig, factor_corr_fig, loadings_heatmap_fig
...
def build_fit_figures(view, gof, yrep, data, raw, bench, mod, idata,
    ...
    from analysis import (mirt_difficulty_timeline_df, mirt_human_axis_stats,
