...
from viz.compare import (
    ...
    cmp_axis_collapse_fig,
    cmp_axis_match_fig,
    cmp_axis_reproducibility_fig,
    cmp_convergence_fig,
    cmp_gof_fig,
...
__all__ = [
    ...
    "cmp_axis_reproducibility_fig", "cmp_pit_ecdf_fig", "cmp_loo_ladder_fig",
    "cmp_loo_waic_fig",
    "cmp_pareto_k_fig", "cmp_loo_vs_trust_fig", "cmp_tau_spectrum_fig",
    "cmp_axis_match_fig", "cmp_axis_collapse_fig", "alignment_methods_fig",
    "delpd_se",
