...
```
python 3_fit.py --preset canonical --chains 4 --draws 2000 --tune 2000
python 3_fit.py --preset canonical --open-only --chains 4 --draws 2000 --tune 2000
python 3_fit.py --preset canonical --closed-only --chains 4 --draws 2000 --tune 2000
./make_plots.sh
```
